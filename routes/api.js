...
try {
var ikyyAds = db.get("ikyyAds");
} catch (e) {
	console.log('')
}

var creatorList = ['@ikyy_ads','@ikyy_ads','@ikyy_ads','@ikyy_ads', '@ikyy_ads','@ikyy_ads','@ikyy_ads'];
...
loghandler = {
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'apikey invalid, gak punya apikey? chat gw aja yaaa di wa.me/6283141727903 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
var len = 15
 ...
 async function cekApiKey(api) {
 	ap = await の ＭｅＩｋｙ あ.findOne({apikey:api})
 return ap;
 }
router.get('/find', async (req, res, next) => {
    var apikey = req.query.apikey
    if (!apikey) return res.json(loghandler.notparam)
    if (apikey != 'Meikyapi') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Meikyapi') return res.json(loghandler.invalidKey)
...
router.get('/wikipedia', async (req, res, next) => {
	...
	if(apikeyInput != 'Meikyapi') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-api-の ＭｅＩｋｙ あr.herokuapp.com/api/wiki?keyword=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/randomquote/muslim', async (req, res, next) => {
	...
	if(apikeyInput != 'Meikyapi') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-api-の ＭｅＩｋｙ あr.herokuapp.com/api/quote?type=agamis`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/drakorasia', async (req, res, next) => {
	...
	if(apikeyInput != 'Meikyapi') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`http://docs-api-の ＭｅＩｋｙ あr.herokuapp.com/api/drakorasia?search=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/cuaca', async (req, res, next) => {
	...
	if(!kabupaten) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kabupaten"})
       fetch(encodeURI(`https://docs-api-の ＭｅＩｋｙ あr.herokuapp.com/api/cuaca?kabupaten=${kabupaten}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/random/meme', async (req, res, next) => {
	...
	if(apikeyInput != 'Meikyapi') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-api-の ＭｅＩｋｙ あr.herokuapp.com/api/meme`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/quotes/kanye', async (req, res, next) => {
	...
	if(apikeyInput != 'Meikyapi') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-api-の ＭｅＩｋｙ あr.herokuapp.com/api/quote?type=kanye`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/translate', async (req, res, next) => {
	...
	if(apikeyInput != 'Meikyapi') return res.json(loghandler.invalidKey)
	if(!kata) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
       fetch(encodeURI(`https://docs-api-の ＭｅＩｋｙ あr.herokuapp.com/api/translate?text=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/anime/kusonime', async (req, res, next) => {
	...
	if(apikeyInput != 'Meikyapi') return res.json(loghandler.invalidKey)
	if(!search) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter search"})
       fetch(encodeURI(`https://docs-api-の ＭｅＩｋｙ あr.herokuapp.com/api/kusonime?search=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/gabut', async (req, res, next) => {
	...
	if(apikeyInput != 'Meikyapi') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-api-の ＭｅＩｋｙ あr.herokuapp.com/api/bosan`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/manga', async (req, res, next) => {
	...
	if(apikeyInput != 'Meikyapi') return res.json(loghandler.invalidKey)
	if(!search) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter search"})
       fetch(encodeURI(`https://docs-api-の ＭｅＩｋｙ あr.herokuapp.com/api/manga?keyword=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/random/wallpaper', async (req, res, next) => {
	...
	if(apikeyInput != 'Meikyapi') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-api-の ＭｅＩｋｙ あr.herokuapp.com/api/random/wallpaper?genre=acak`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/kuis/caklontong', async (req, res, next) => {
	...
	if(apikeyInput != 'Meikyapi') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-api-の ＭｅＩｋｙ あr.herokuapp.com/api/quote?type=caklontong`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/kuis/tebakgambar', async (req, res, next) => {
	...
	if(apikeyInput != 'Meikyapi') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-api-の ＭｅＩｋｙ あr.herokuapp.com/api/quote?type=tebakgambar`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
